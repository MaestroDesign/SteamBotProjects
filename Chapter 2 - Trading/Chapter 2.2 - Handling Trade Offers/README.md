...
To start off this chapter, make a new folder on your pc and call it 'Chapter 2'To start off this chapter, let's duplicate the code we made in the previous
